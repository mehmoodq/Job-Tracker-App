...
export default class EditApplication extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:5000/applications" + this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        "http://localhost:5000/applications/update/" +
